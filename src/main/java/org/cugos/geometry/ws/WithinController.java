...
public class WithinController {
  ...
  public HttpResponse get(
    ...
    return within(from, geometryString);
  }
  ...
  private HttpResponse within(String from, String geometryString) throws Exception {
    ...
    if (Validator.hasRequiredNumberOfGeometries(geometry, 2)) {
      ...
      boolean result = firstGeometry.within(secondGeometry);
