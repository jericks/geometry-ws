...
@Controller("/arcPolygon")
public class ArcPolygonController {
  
  @Get("/{from}/{to}")
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(operationId = "arc polygon get", summary = "Arc Polygon", description = "Creates an arc polygon from a start angle and an angle extent.")
  public HttpResponse get(
    ...
    return createArcPolygon(from, to, geometryString,
  ...
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(operationId = "arc polygon post", summary = "Arc Polygon", description = "Creates an arc polygon from a start angle and an angle extent.")
  ...
  private HttpResponse createArcPolygon(String from, String to, String geometryString,
    ...
    Geometry arc = geometricShapeFactory.createArcPolygon(startAngle, angleExtent);
