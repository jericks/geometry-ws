...
public class CentroidController {
  ...
  public HttpResponse get(
    ...
    return centroid(from, to, geometryString);
  }
  ...
  private HttpResponse centroid(String from, String to, String geometryString) throws Exception {
    GeometryReader reader = GeometryReaders.find(from);
    GeometryWriter writer = GeometryWriters.find(to);
    Geometry geometry = reader.read(geometryString);
    Geometry centroid = geometry.getCentroid();
    String content = writer.write(centroid);
