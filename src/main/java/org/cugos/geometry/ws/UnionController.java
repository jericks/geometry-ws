...
public class UnionController {
  ...
  @Operation(operationId = "union get", summary = "Union", description = "Calculate the union between two geometries")
  public HttpResponse get(
      @Parameter(description = "Input Geometry Format (wkt, geojson, kml, gml2)")  String from,
      @Parameter(description = "Output Geometry Format (wkt, geojson, kml, gml2)") String to,
      @Parameter(description = "Input Geometry") @QueryValue("geom") String geometryString) throws Exception {
    return union(from, to, geometryString);
  }

  @Post("/{from}/{to}")
  @Consumes(MediaType.TEXT_PLAIN)
  @Produces(MediaType.TEXT_PLAIN)
  @Operation(operationId = "union post", summary = "Union", description = "Calculate the union between two geometries")
  ...
  private HttpResponse union(String from, String to, String geometryString) throws Exception {
    ...
    if (Validator.hasRequiredNumberOfGeometries(geometry, 2)) {
      ...
      Geometry result = firstGeometry.union(secondGeometry);
